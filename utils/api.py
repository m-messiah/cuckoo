...
@app.route(app.config["APPLICATION_ROOT"] + "/tasks/screenshots/<int:task_id>")
@app.route(app.config["APPLICATION_ROOT"] + "/v1/tasks/screenshots/<int:task_id>")
@app.route(app.config["APPLICATION_ROOT"] + "/tasks/screenshots/<int:task_id>/<screenshot>")
@app.route(app.config["APPLICATION_ROOT"] + "/v1/tasks/screenshots/<int:task_id>/<screenshot>")
...
@app.route(app.config["APPLICATION_ROOT"] + "/memory/list/<int:task_id>")
...
@app.route(app.config["APPLICATION_ROOT"] + "/memory/get/<int:task_id>/<pid>")
...
@app.route(app.config["APPLICATION_ROOT"] + "/vpn/status")
def vpn_status():
